...
**Last updated:** 2026-07-24 (Phases C, D, E **and F** built + QA'd — **StoneTweaks is RETIRED: disabled,
folder out of AddOns, the Hub serves all media alone, compat shim live and proven.** The identity
scrub — TASK 0 — is DONE and all five repos are PUBLIC. **NEXT = Phase G, packaging/release.
★ Its blocker: GloomsHub has NO `.pkgmeta` and NO release workflow, so it cannot publish — and
GB/GA/Overlays all hard-depend on it. Briefing in HANDOFF.md.**)
